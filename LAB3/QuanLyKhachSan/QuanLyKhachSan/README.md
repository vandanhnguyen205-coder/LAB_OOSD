Nguyễn Văn Danh - 1250080027 - Lab3 
-
- đã thiết được 6 form giao diện 
- 
-Yêu cầu môi trường
...
- Mở file: Data/Db.cs → tìm dòng:
 csharp
 Run
 string chuoiKetNoi = @"Data Source=DESKTOP-XXX;Initial Catalog=QLKhachSan;Integrated Security=True";
- Chạy Dữ liệu mẫu của CSDL: HOTEL.sql
